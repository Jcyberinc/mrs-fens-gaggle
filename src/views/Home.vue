    ...
    >
      ...
      >
        ...
        <p v-if="maxGoose > 0 && maxGoose <= 20">
          ...
          an odd duck than a goose! Try again. I’m sure you can do much better
          than that. Told ya this is tough work. If ya can’t handle it you
          should go breed ducks. It seems you’re a natural at it!
        </p>
        <p v-if="maxGoose > 20 && maxGoose <= 40">
          ...
          gimme that look! You’re improvin’, slowly but surely. Just keep
          workin’ on yer skills and I’m sure you’ll create a mighty fine goose!
          Even if it’ll probably take ya a couple years longer than usual…
        </p>
        <p v-if="maxGoose > 40 && maxGoose <= 60">
          ...
          shame but what can ya do? Most geese I’ve seen in ma life have been
          like this one so I wouldn’t be ashamed.
        </p>
        <p v-if="maxGoose > 60 && maxGoose <= 80">
          You’re gettin’ there with that goose over there! Just gotta keep at it
          for a bit longer. Haha! Ya sure are learnin’ faster than I thought.
          I’d never thought in ma life that someone like you could get this
          close to the levels of a professional like me, yet here ya are.
        </p>
        <p v-if="maxGoose > 80 && maxGoose <= 90">
          Ooo… you’re gettin’ so close! I could feel it in ma bones. Just trust
          me on this one, I have years of experience to back it up. I’m sure
          you’ll get the goose of your dreams soon if you keep at it!
        </p>
        <p v-if="maxGoose > 90 && maxGoose <= 95">
          ...
          ya worked hard enough. Look at how far you’ve come! Now I’ve seen
          geese better than this one, but that might be difficult even for you.
        </p>
        <p v-if="maxGoose > 95 && maxGoose <= 99">
          WOWZERS! I shoulda seen this one comin’ but you’ve exceeded all ma
          expectations. I’ve only seen a few geese in ma life as amazin’ as this
          one. And trust me I’ve seen plenty of geese, probably more than a sane
          person should. Could there be a better goose out there? I’m not sure
          if it’s even possible but hm…
        </p>
        <p v-if="maxGoose > 99">
          Oh. My. Heavens! I… I can’t believe it! I never thought I would see a
          goose as perfectly holy and divine as this one. Yet here’s one right
          before me. If there’s a god of geese out there I bet ma money that
          this one here would lead them all. Words can’t describe how proud I am
          of you. I deem this goose a Zoose out of 100.
        </p>
      </div>
    </div>
    <img
